...
openapi-type: arm
tag: package-preview-2019-09
```


### Tag: package-preview-2019-09

These settings apply only when `--tag=package-preview-2019-09` is specified on the command line.

```yaml $(tag) == 'package-preview-2019-09'
input-file:
  - Microsoft.OperationalInsights/preview/2019-09-01-preview/OperationalInsights.json
```
